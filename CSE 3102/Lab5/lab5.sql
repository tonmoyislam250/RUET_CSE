...
-- WHERE Age < 18 --  Query 1.2: Find how many movies are there in each genre with an IMDB
--     -- rating greater than or equal to 8.0 from movie-character relationship table.
